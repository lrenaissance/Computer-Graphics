/*
* <�ڵ� �ۼ�. ������ ���>
* HW1�� LearnOpenGL src ������ 9.robot_arm�� �߰��Ͽ���,
* �� �ȿ� 1.RobotArm�̶�� ������ �߰��Ͽ�, �� ������ HW3�� �������� ���ϵ��� �־����ϴ�.
...
* set(CHAPTERS
	...
	�̷��� �� ���� �߰��� ��, HW1ó�� Cmake GUI�� �̿��� ������ LearnOpenGL sln ���Ͽ��� �����Ͽ����ϴ�.
	teapot�̶� wood�� ��Ÿ���� �ʾƼ�, bin/9.robot_arm/Debug ���Ͽ� teapot.obj�� wood.png�� �־��־����ϴ�.
*/
...
#include <learnopengl/camera.h> //camera ����
...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		PhongShader->use();
		PhongShader->setMat4("projection", glm::perspective(glm::radians(camera.Zoom), (float)SCR_WIDTH / (float)SCR_HEIGHT, 0.1f, 100.0f)); //proj ����
		PhongShader->setMat4("view", camera.GetViewMatrix()); //view �ҷ�����
...
void initGL(GLFWwindow** window)
{
	...
	* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "The Robot Arm", NULL, NULL);
	...
	glfwSetScrollCallback(*window, scroll_callback); //scroll �߰�
...
void mouse_callback(GLFWwindow* window, double xpos, double ypos)
{
	...
	if (RightButtonDown) {
		//view direction �ٲ�� �ӵ��� �ʹ� ������ ���� offset�� 100��� ����
