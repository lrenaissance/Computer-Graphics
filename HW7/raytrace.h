...
private:
	...
	raytraceData::cylinder* raytrace::makeCylinder(GLfloat x1, GLfloat y1, GLfloat z1, GLfloat xn, GLfloat yn, GLfloat zn, GLfloat r, GLfloat h); //cy 추가
	...
	raytraceData::cylinder* c1; //cylinder 추가
